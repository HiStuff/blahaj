import { ActionRowBuilder, ButtonInteraction, ChannelType, ComponentType, Message, MessageFlags, StringSelectMenuBuilder, StringSelectMenuOptionBuilder } from "discord.js";
...
export default {
    ...
    async clicked(client: FembotClient, interaction: ButtonInteraction) {
		...
		collector.on("collect", async i => {
			...
			let ticket = new Ticket(client, interaction.guild, undefined, interaction.user, i.values[0]);
