...
import { ActionRowBuilder, CategoryChannelResolvable, ChannelType, Client, Collection, Events, GatewayIntentBits, Interaction, InteractionType, MessageFlags, ModalBuilder, OverwriteType, TextInputBuilder, TextInputComponent, TextInputStyle } from "discord.js";
import * as log from "./utils/logger.js";
import { CommandCategories, CommandFlags, FembotClient, IButton, ICommand } from "./types.js";
...
client.on(Events.InteractionCreate, async interaction => {
    try {
        ...
        if (interaction.isButton() && guild) {
            if (interaction.customId.startsWith("cmt-")) { await handleCustomMenuButtonClick(client, interaction); }
