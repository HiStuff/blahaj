			...
			subcommand
				...
				.addUserOption((option) =>
					option
						.setName("user")
						.setDescription(
							"Użytkownik któremu chcesz nadać status developera.",
						)
						.setRequired(true),
				),
		)
			...
			subcommand
				...
				.addUserOption((option) =>
					option
						.setName("user")
						.setDescription(
							"Użytkownik któremu chcesz sprawdzić status developera.",
						)
						.setRequired(true),
				),
		)
			...
			subcommand
				...
				.addUserOption((option) =>
					option
						.setName("user")
						.setDescription(
							"Użytkownik któremu chcesz zabrać status developera.",
						)
						.setRequired(true),
				),
		),
		...
		switch (interaction.options.getSubcommand(true)) {
			case "nadaj":
				...
				const embed1 = new EmbedBuilder()
					.setTitle("Nadano.")
					.setDescription(
						`Nadano status Developera użytkownikowi ${user}!`,
					)
					.setColor(0x00ff00)
			...
			case "zabierz":
				...
				const embed2 = new EmbedBuilder()
					.setTitle("Zabrano.")
					.setDescription(
						`Zabrano status Developera użytkownikowi ${user}!`,
					)
					.setColor(0x00ff00)
					.setTimestamp(new Date());
			...
			case "sprawdz":
				...
				const embed3 = new EmbedBuilder()
					.setTitle(
						targetUserFromDatabase?.developer
							? "Posiada."
							: "Nie posiada.",
					)
					.setDescription(
						`Użytkownik ${user} ${targetUserFromDatabase?.developer ? "" : "nie"} posiada status${dbUser.developer ? "" : "u"} Developera!`,
					)
					.setColor(
						targetUserFromDatabase?.developer ? 0xff0000 : 0x00ff00,
					)
					.setTimestamp(new Date());
