import { Client, ChatInputCommandInteraction, EmbedBuilder, SlashCommandBuilder, Team, User, version, MessageFlags } from "discord.js";
	...
	data: new SlashCommandBuilder()
        ...
        .addSubcommand(subcommand => subcommand
            ...
            .addUserOption(option => option
                .setName("user")
                .setDescription("Użytkownik któremu chcesz zabrać kase.")
                .setRequired(true)
            )
            ...
            .addUserOption(option => option
                .setName("user")
                .setDescription("Użytkownik którego chcesz sprawdzić stan konta.")
                .setRequired(false)
            )
        ),
        ...
        switch (interaction.options.getSubcommand()) {
            ...
            case "sprawdz":
                const embed3 = new EmbedBuilder()
                    .setTitle("Operacja wykonana pomyślnie.")
                    .setDescription(`Stan konta użytkownika ${user} wynosi \`${dbUser.balance} waluty\`.`)
                    .setColor(0x00FF00)
                    .setTimestamp(new Date());
