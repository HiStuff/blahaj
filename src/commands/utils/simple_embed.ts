...
export default {
	data: new SlashCommandBuilder()
		...
		.setDescriptionLocalizations(
			client.lang.getDescriptionLocalizations("simpleembed"),
		)
		...
		.addStringOption((option) =>
			option
				...
				.setNameLocalizations(
					client.lang.getNameLocalizations("simpleembed_title"),
				)
				.setDescriptionLocalizations(
		...
		.addStringOption((option) =>
			option
				...
				.setNameLocalizations(
					client.lang.getNameLocalizations("simpleembed_description"),
				)
				.setDescriptionLocalizations(
					client.lang.getDescriptionLocalizations(
						"simpleembed_description",
					),
				)
				.setRequired(true),
		)
		.addStringOption((option) =>
			option
				...
				.setNameLocalizations(
					client.lang.getNameLocalizations("simpleembed_color"),
				)
				.setDescriptionLocalizations(
					client.lang.getDescriptionLocalizations(
						"simpleembed_color",
